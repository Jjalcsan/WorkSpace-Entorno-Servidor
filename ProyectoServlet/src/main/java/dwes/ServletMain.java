...
public class ServletMain extends HttpServlet{
	...
	/**
	 * El metodo doGet primero mirará que exista la sesión. Si existe, nos llevará al resumen del pedido sacando por pantalla las lineas de nuestro pedido
	 * con el total de unidades y precio de cada producto, ademas aqui podremos seleccionar el metodo de envio antes de dirigirnos a la factura.
	...
	public void doGet(HttpServletRequest request,
		...
		if(sesion.getAttribute("nombre")==null) { //Si la sesion no existe nos devuelve al login
		    ...
		    out.println ("<label for=\"contra\">Contrasenia:</label>");
		...
		} else { //Si la sesion existe nos muestra por pantalla nuestro carrito con las unidades, el total y el tipo de envio
