...
<div id="div-con-todo">
    <div id="header">
        <div id="div-titulo">
            <p id="p-titulo">HR Online</p>
            <p id="p-subtitulo">La página de registro online de nuevas viviendas</p>
        </div>
        <div id="div-menu">
            <p id="p-opciones"><a href="index.jsp">Inicio</a>&nbsp;&nbsp;<a href="registroForm.jsp">Registre una nueva vivienda</a>&nbsp;&nbsp;<a href="viviendasActuales.jsp">Observe la ultima vivienda añadida</a></p>
        </div>
    </div>
    <div id="div-contenido">
    	<h1>
    	<!-- Ponemos este scriptlet para que si no es la primera vez que accedemos a la pagina nos salude de nuevo  -->
    	<%
    	Integer contador = (Integer)application.getAttribute("contador");
    	if (contador == null || contador == 0){
    		out.println("Bienvenido a HR Online");
        ...
        <h1>¿Por qué es conveniente inscribir una vivienda en el Registro de la Propiedad?</h1>
        <p>Cuando se realiza la compra de una vivienda hay que hacer numerosos trámites. Uno de ellos, una vez que se ha completado la adquisición del inmueble, es inscribirlo en el Registro de la Propiedad. Esta institución pública es la encargada de crear titularidades sobre bienes inmuebles para favorecer la seguridad jurídica de los mismos.</p>
        <p>Además de servir para pisos nuevos y casas de obra nueva, el Registro de la Propiedad también cumple una importante función durante el proceso de búsqueda de una vivienda de segunda mano: comprobar que la casa está libre de cargas y deudas. Para ello, es necesario acudir al Registro y solicitar una Nota Simple. Este documento informativo aportará estos datos, además de la titularidad del inmueble.</p>
    </div>
    <div id="div-footer">
        <div id="div-enlaces">
            <table aria-describedby="tabla">
        ...
        <div id="div-copyright">
            <p>©2021 Jacaranda Spain SL</p>
            <!-- Declaramos el numero de accesos actuales -->
            <%! private int accesosActuales = 0;%>
            <!-- Y con esta expresion sacamos el resultado por pantalla -->
            <p> Ya has visitado mi página <%= ++accesosActuales %> veces </p>
        </div>
    </div>   
</div>
</body>
>>>>>>> 62a2fdb3f06155efdb0c1df0f63791d670d6cb3b
</html>